...
<div class="row">
        ...
        <div class="col-2">
            <div class="form-group">
                ...
                <select class="form-control" style="width:100%;" name="product_id" id="product_id" onchange="filter_by_product(this.value)">
                <option value="">Select</option>
        ...
        <div class="col-2">
            <div class="form-group">
                ...
                <select class="form-control child_cat_id" style="width:100%;" name="cat_id" id="cat_id" onchange="fetch_products_by_cat(this.value)">
        ...
        <div class="col-2">
            <div class="form-group">
                ...
                <select class="form-control" style="width:100%;" name="plan_type_id" id="plan_type_id" onchange="filter_by_plan_type(this.value)" disabled>
                <option value="">Select</option>
...
<div id="datatable">
    <?php if(!empty($to_date)) { 
        ...
        <div class="row">
            <div class="col-md-2">
            <a href="<?= base_url('reports/sales_report/export_to_excel/'.$from_date.'/'.$to_date.'/'.$pmid.'/'.$status_id.'/'.$search."/".$brand_id."/".$parent_id."/".$parent_cat_id."/".$child_cat_id."/".$product_id."/".$subscription."/".$plan_type_id); ?>" class="btn btn-primary btn-sm mb-3"><i class="fas fa-arrow-down"></i> Export to Excel</a>
            </div>

...
<div class="row mt-4">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 mb-1">
                        <div class="pull-left">
                            <input type="text" name="item" value="" id="item" placeholder="Start typing Item Name or scan Barcode..." class="form-control input-sm ui-autocomplete-input" size="50" tabindex="1" autocomplete="off">
                            <span class="ui-helper-hidden-accessible" role="status"></span>
                        </div>
                    </div>
                    <!-- <div class="col-lg-2 col-md-2">
                        <div class="pull-right">
                            <button class="float-right btn btn-primary" href="javascript:void(0)" data-toggle="modal" data-target="#showModal" data-whatever=""><span class="fa fa-tag">&nbsp;</span>New Item</button>
                        </div>
                    </div> -->
                </div>
            </div>
                ...
                <table class="jsgrid-table" id="item-table">
                    <thead>
                        <tr class="jsgrid-header-row">
                            ...
                            <th class="jsgrid-header-cell jsgrid-align-center" style="width:12%">Discount / Unit Price</th>
                            <th class="jsgrid-header-cell jsgrid-align-center" style="width:12%">Discount2 / Unit Selling Price</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr class="noItem">
                            <td class="jsgrid-cell jsgrid-align-center" colspan="9">
                                <div class="alert alert-dismissible alert-info mb-0">There are no Items in the cart.</div>
                            </td>
                        </tr>
                    </tbody>
                </table>
    ...
    $('body').on('input','input[name=manual_order_number]',function(e){
        check_order_id();
    })
        ...
        <div class="card mb-0">
            ...
            <div class="card-body pb-0">
                ...
                <div id="Customer_div" class="table-responsive" style="display:none;">
                    ...
                    <table class="jsgrid-table" id="customer_totals">
                        <tbody id="Customer-record">
                            ...
                            <tr>
                                <th style="width: 55%;">Contact Person Name</th>
                                <td style="width: 45%; text-align: right;" class="ContactPerson"></td>
                            </tr>
                            <tr>
                ...
                <div class="form-group mb-0" id="select_customer">
                    ...
                    <p></p>
                    <div class="center">
                        <button class="btn btn-primary" href="javascript:void(0)" data-toggle="modal" data-target="#modalcustomer" data-whatever=""><span class="fa fa-user">&nbsp;</span>New Customer</button>&nbsp;&nbsp;
            ...
            <div class="">
                <div id="" class="table-responsive" style="padding-left: 13px;padding-right: 13px;">
                    <table class="jsgrid-table" >
                        <tbody >
                            <tr class="jsgrid-header-row">
                                <th style="width: 55%;">Is pay later</th>
                                <td style="width: 45%; text-align: right;">
                            ...
                            <tr class="payment-receive">
                                <th style="width: 100%;text-align: center;" colspan="2">Reference No. / Remark </th>
                                
                            </tr>
                            <tr class="payment-receive">
                                <td style="width: 100%; text-align: center;" colspan="2">
                                    <input type="text" name="reference_no_or_remark" id="reference_no_or_remark" class="form-control form-control-sm">
                                </td>
                            </tr>
...
<div class="modal fade text-left" id="modalcustomer" tabindex="-1" role="dialog" aria-labelledby="myModalLabel21" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel21">Add Customer</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form class="ajaxsubmit needs-validation reload-tb" id="AddCustomer" action="" method="post">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-6">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="alternate_mobile" id="alternate_mobile">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="customer_category" id="customer_category">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label class="control-label">Customer Profile:</label>
                                    <input type="text" class="form-control" name="customer_profile" id="customer_profile">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" onchange="CheckCustomerCode()" name="customer_code" id="customer_code">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea cols="92" rows="5" class="form-control" name="address" id="address"></textarea>
                                </div>
                            </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button id="btnsubmit" type="button" onclick="SubmitCustomer()" class="btn btn-danger waves-light"><i id="loader" class=""></i>Add</button>
...
<script type="text/javascript">
    ...
    function CheckCustomerCode() {
        $.ajax({
            url: "<?php echo base_url('check-customer-code/'); ?>",
            method: "POST",
            data: {
    ...
    function SubmitCustomer() {
        if ($("#name").val() == '') {
            toastr.warning('Please fill Customer Name', 'Warning', 'positionclass:toast-bottom-full-width');
            return;
        }
        if ($("#email").val() == '') {
        ...
        $.ajax({
            url: "<?php echo base_url('pos/pos_data/save'); ?>",
            method: "POST",
            data: {
                name: $("#name").val(),
                email: $("#email").val(),
    ...
    $("#customer").autocomplete({
        source: function(request, response) {
            // Fetch data
            $.ajax({
                url: "<?= base_url() ?>pos/pos_data/getcustomer",
                type: 'post',
                dataType: "json",
                data: {
                    search: request.term
    ...
    $("#item").autocomplete({
        source: function(request, response) {
            // Fetch data
            $.ajax({
                url: "<?= base_url() ?>pos/pos_data/getitem",
                type: 'post',
                dataType: "json",
                data: {
                    search: request.term
        ...
        select: function(event, ui) {
            ...
            $('#item-table > tbody  > tr').each(function(i, j) {
                $(this).find(".product_code").each(function() {
                    if (ui.item.product_code == $(this).html()) {
            ...
            if (productCode != ui.item.product_code) {
                ...
                ProductTable += "<td class='jsgrid-cell jsgrid-align-center'>" + ui.item.label + "<br>[Total Stock : " + ui.item.qty + "]</td>";
                ProductTable += "<td class='jsgrid-cell jsgrid-align-center omrp'> " + ui.item.mrp + "</td>";
                ProductTable += "<td class='jsgrid-cell jsgrid-align-center mrp'> " + ui.item.mrp + "</td>";
                ...
                ProductTable += "<td class='jsgrid-cell jsgrid-align-center quantity1'><input type='text'  onkeypress='return /[0-9]/i.test(event.key)'  name='qty' id='quantity' class='form-control form-control-sm' value='1'></td>";


                ProductTable += "<td class='jsgrid-cell jsgrid-align-center totalamount'> " + ui.item.mrp + " </td>";
                ProductTable += "<td class='jsgrid-cell jsgrid-align-center Disc'><input type='text'  onkeypress='return /[0-9]/i.test(event.key)'  name='discount' id='discount' onkeyup='getdiscount(this.value,`" + ui.item.product_code + "`,`" + ui.item.mrp + "`)' class='form-control form-control-sm discount' value=''><label class='switch'><input type='checkbox' onclick='SetValueBlank(`" + ui.item.product_code + "`,`Disc`)' class='togBtn'><div class='slider round'><!--ADDED HTML --><span class='on'>Fixed</span><span class='off'>%</span><!--END--></div></label></td>";
                ProductTable += "<td class='jsgrid-cell jsgrid-align-center Disc2'><input type='text'  onkeypress='return /[0-9]/i.test(event.key)'  name='discount2' id='discount2' onkeyup='getdiscount2(this.value,`" + ui.item.product_code + "`)' class='form-control form-control-sm discount' value=''><label class='switch'><input type='checkbox' onclick='SetValueBlank(`" + ui.item.product_code + "`,`Disc2`)' class='togBtn2'><div class='slider round'><!--ADDED HTML --><span class='on'>Fixed</span><span class='off'>%</span><!--END--></div></label></td>";
            ...
            if ($('#item-table >tbody >tr').length == 2 && productCode != ui.item.product_code) {
                var GetResult = GetSaleRecord(ui.item.mrp, ui.item.tax_value)
                var getV = GetResult.split(",");
                var AmountwithoutTax = getV[0];
                var TaxValue = getV[1];
...
$('body').on('change | input', 'input[name=qty]',function(){
    ...
    function getdiscount(Discount, ProductCode, SellingPrice,is_discount1=true,togBtnClass='.togBtn') {
        var togBtn = Boolean;
        var TaxValue = '';
        var Quantity = '';
        var productCode = '';
    ...
    function getdiscount2(Discount, ProductCode) {
        var togBtn = Boolean;
        var TaxValue = '';
        var SellingPrice = '';
        var productCode = '';
        ...
        if (Disc != "") {
            getdiscount(Discount, ProductCode, SellingPrice,is_discount1=false,togBtnClass='.togBtn2')
        } else(
    ...
    function SetValueBlank(ProductCode, disTd) {
        $('#item-table > tbody  > tr').each(function(i, j) {
            $(this).find(".product_code").each(function() {
                if ($(this).html() == ProductCode) {
                    ...
                    $(this).closest('tr').find(`.${disTd} input`).val('');
                }
            });
        });
    }

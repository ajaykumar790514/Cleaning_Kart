    ...
    <div class="row">
        ...
        <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="customer_type" value="<?= $value->customer_type; ?>">
                </div>
            </div>
            <div class="col-6">
                <div class="form-group">
                    <label class="control-label">Customer Category:</label>
                    <input type="text" class="form-control" name="customer_category" value="<?= $value->customer_category; ?>">
                </div>
            </div>
            <div class="col-6">
                <div class="form-group">
                    <label class="control-label">Contact Person Name:</label>
                    <input type="text" class="form-control" name="contact_person_name" value="<?= $value->contact_person_name; ?>">
                </div>
            </div>
            <div class="col-6">
                <div class="form-group">
                    <label class="control-label">Customer Profile:</label>
                    <input type="text" class="form-control" name="customer_profile" value="<?= $value->customer_profile; ?>">
                </div>
            </div>
        <div class="col-6">
            <div class="form-group">
        ...
        <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="aadhar_no" id="aadhar_no" value="<?=$value->aadhar_no?>" >
                </div>
            </div>
        <div class="col-6">
                    <div class="form-group">

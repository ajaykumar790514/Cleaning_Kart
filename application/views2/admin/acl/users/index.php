                ...
                <div class="row">
                    <div class="col-12">
                        <div class="d-flex flex-wrap">
                            ...
                            <div class="float-left col-md-6 col-lg-6 col-sm-6">
                                <button class="float-right btn btn-primary" href="javascript:void(0)" data-toggle="modal" data-target="#showModal" data-whatever="Add New User Role" data-url="<?=$new_url?>" >Add New User</button>
                            </div>

...
class master_model extends CI_Model
{
	...
	public function get_property_val($id)
	{
        ...
        {
            $cond = array('shop_id' => $shop_id, 'is_deleted' => 'NOT_DELETED', 'active' => 1, 'user_type' => 1);
            return $this->db->order_by('name','asc')->get_where('vendors',$cond)->result();
        }    

        public function get_customers($shop_id)
        {
            $cond = array('shop_id' => $shop_id, 'is_deleted' => 'NOT_DELETED', 'active' => 1, 'user_type' => 2);
            return $this->db->order_by('name','asc')->get_where('vendors',$cond)->result();
        }      

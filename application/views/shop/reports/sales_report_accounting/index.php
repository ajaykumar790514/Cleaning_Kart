...
<div class="row page-titles">
    <div class="col-md-5 col-8 align-self-center">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Sales Report Accounting</li>
        </ol>
    </div>
</div>
<!-- ============================================================== -->
                    ...
                    <div class="col-12">
                        <div class="d-flex flex-wrap">
                            <div class="float-left col-md-6 col-lg-6 col-sm-6">
                                <h3 class="card-title" id="test">Sales Accounting Data</h3>
...
var timer;
        ...
        $(document).on('keyup', '#tb-search', function(event){
            ...
            timer = setTimeout(function(){
                ...
                // console.log(search);
                var tbUrl = $('[name="tb"]').val();
                $.post(tbUrl,{search:search,from_date:from_date,to_date:to_date,pm_id:pm_id})
                .done(function(data){
                    $('#tb').html(data);
                })
            }, timeout);

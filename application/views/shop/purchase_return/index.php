...
<div class="row page-titles">
    <div class="col-md-5 col-8 align-self-center">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="stocks">Purchase Return</a></li>
                    ...
                    <div class="col-12">
                        <form action="<?=$tb_url?>" class="tb-filter" method="post">
                            ...
                            <div class="col-2">
                                <div class="form-group">
                                <label class="control-label"><br></label>
                                <input type="button" class="form-control btn btn-primary text-white" id="add-purchase-return" value="Add Purchase Return" data-toggle="modal" data-target="#showModal" data-whatever="Add Purchase Return" data-url="<?=base_url()?>purchase_return/return"> 
                                </div>
                            </div>
                        </form>
                    </div>

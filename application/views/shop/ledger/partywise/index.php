...
<div class="row page-titles">
    <div class="col-md-5 col-8 align-self-center">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Partywise Report</li>
        </ol>
    </div>
</div>
<!-- ============================================================== -->
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-12 p-hide">
                        ...
                        <div class="col-4" id="customer-div">
                            <div class="form-group">
                        ...
                        <div class="col-12" style="margin-top: 10px;">
                            <div class="form-group">
                                ...
                                <button type="reset" class="btn btn-sm btn-danger" id="reset-data">Reset</button>
                            </div>
                        </div>
